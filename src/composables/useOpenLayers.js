...
const wmsBaseUrl ="http://localhost:8080"  // "http://7264ad3242b4.ngrok.io"; // "http:192.168.43.35"; // "http://172.20.10.2"; // or ;
...
export function useOpenLayers() {
  ...
  const layers = [
    ...
    new TileLayer({
      source: new TileWMS({
        url: `${wmsBaseUrl}/geoserver/maworld/wms`,
        params: { LAYERS: "maworld:countriesdbpedia", TILED: true },
